...
# PM_LOCATE=os.path.dirname(__file__)+"/Tests/"                         # Provide path to PM file and instructions here
...
def run(a):
    ...
    # start=time.time()
    g=open(a+"/"+"instr.txt","rt")                                  #Changed
    #b=input("Enter name of OpCode Destination file:")
    f=open(a+"/pm_file.txt","wt")                                      #Changed
    # f.write(16*"1"+16*"0"+"\n")
    l=[]
    rewrite=False
    instr_list=[]
