...
def run(folder):
    put_to_reg('01100000','0000000000000000')
    put_to_reg('01100001','0000000000000000')
    put_to_reg('01100011','0000000000000000')
    put_to_reg('01100100','0000000000000000')
    put_to_reg('01100101','0000000000000000')
    put_to_reg('01111011','0000000000000000')
    put_to_reg('01111100','0000000000000000')
    put_to_reg('01111110','0000000000000001')
    global path
    path = folder
    f=open(path+"/pm_file.txt","rt")
    g=open(path+"/reg_dump.txt","wt")
    try:
        h=open(path+"/dm_file.txt","rt")
    except:
        h=open(path+"/dm_file.txt","wt")
    ...
    f=open(path+"/dm_file.txt","rt")
    g=open(path+"/"+"expected.txt","rt")
    __o=True
    for i,j in zip(f,g):
